...
#!/bin/bash
echo "========================================================================="
echo "---> Setar 1440000 em tcp_max_tw_buckets"
echo "========================================================================="
# Setar 1024 em tcp_max_tw_buckets
echo > 1024 /proc/sys/net/ipv4/tcp_max_tw_buckets && echo 'Setando valor em tcp_max_tw_buckets = 1440000'
