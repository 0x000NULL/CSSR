...
#!/bin/bash
echo "========================================================================="
echo "---> Setar ON em icmp_echo_ignore_broadcasts"
echo "========================================================================="
# Setar off em tcp_timestamps
echo > 1 /proc/sys/net/ipv4/icmp_echo_ignore_broadcasts && echo 'Setando On em icmp_echo_ignore_broadcasts'
