...
echo "-------------------------------------------------------------------------">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "---> Scanning por users UID = 0 alem do root">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "=========================================================================">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt

echo '[UID = 0 ]' && cat /etc/passwd|grep :0:>>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
