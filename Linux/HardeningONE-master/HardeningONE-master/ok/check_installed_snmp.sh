...
echo "-------------------------------------------------------------------------">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "---> Scanning por objetos SNMP instalados">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "=========================================================================">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt

find / -name snmp -printf '\r' -exec echo '[ SNMP ]' {} \;>>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "=========================================================================">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
