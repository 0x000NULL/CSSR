...
echo "-------------------------------------------------------------------------">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "Scanning no PHP5 por funcao popen">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "-------------------------------------------------------------------------">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
cat /etc/php5/apache2/php.ini|grep popen>>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
