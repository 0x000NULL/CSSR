...
echo "-------------------------------------------------------------------------">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "Scanning no PHP5 por funcao apache_child_terminate">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "-------------------------------------------------------------------------">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo '[PHP5 apache_child_terminate ]' | cat /etc/php5/apache2/php.ini|grep apache_child_terminate>>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
