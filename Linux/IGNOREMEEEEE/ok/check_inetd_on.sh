...
echo "-------------------------------------------------------------------------">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "---> Scanning por services ON no inetd">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "=========================================================================">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt

find / -name inetd -printf %p'\r' -exec echo '[ INETD ]' {} \;>>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "=========================================================================">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
