...
echo "-------------------------------------------------------------------------">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "Scanning por arquivo PHP5 - phpinfo.php">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "-------------------------------------------------------------------------">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
find / -name phpinfo.php>>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
