...
#!/bin/bash
echo "========================================================================="
echo "---> Diminui o tempo padrão para o valor da conexão tcp_fin_timeout"
echo "========================================================================="
# Diminui o tempo padrão para o valor da conexão tcp_fin_timeout
echo > 15 /proc/sys/net/ipv4/tcp_fin_timeout && echo 'tempo padrão para o valor da conexão tcp_fin_timeout = 15'
