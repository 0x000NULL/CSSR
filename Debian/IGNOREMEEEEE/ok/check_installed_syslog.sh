...
echo "-------------------------------------------------------------------------">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "Scanning por syslog">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "-------------------------------------------------------------------------">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt


find / -name "syslog" -printf '\r' -exec echo '[ SYSLOG ]' {} \;>>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
ps aux|grep syslog>>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
