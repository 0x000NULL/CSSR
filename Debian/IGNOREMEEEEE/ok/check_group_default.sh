...
echo "-------------------------------------------------------------------------">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "---> Scanning por Groups Default nao usados">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "=========================================================================">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt

cat /etc/group|grep lp && echo "GROUP LP remover">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
