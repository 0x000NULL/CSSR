...
echo "-------------------------------------------------------------------------">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "---> Scanning por objetos com Permissao Sticky Bit">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "=========================================================================">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt

find / -perm 2750 -printf '\r' -exec echo '[PERM Sticky Bit ]' {} \;>>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
echo "=========================================================================">>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
stat /tmp>>/root/ho/v.0.0.1/hardeningone/tmp/report.txt
