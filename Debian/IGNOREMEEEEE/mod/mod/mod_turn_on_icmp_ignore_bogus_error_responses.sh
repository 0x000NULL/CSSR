...
#!/bin/bash
echo "========================================================================="
echo "---> Setar ON em icmp_ignore_bogus_error_responses"
echo "========================================================================="
# Setar off em icmp_ignore_bogus_error_responses
echo > 1 /proc/sys/net/ipv4/icmp_ignore_bogus_error_responses && echo 'Setando On em icmp_ignore_bogus_error_responses'
